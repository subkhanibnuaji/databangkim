...
export const LIBRARY_CONFIG = {
  ...
  pageTitle: 'Data Book Library',

  /** Deskripsi singkat di hero section */
  pageDescription:
    'Curated collection of essential data books with summaries and downloadable eBooks.',
  ...
  /** Empty state message */
  emptyStateMessage: 'No data books found matching your criteria.',
} as const;
